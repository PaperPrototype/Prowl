using Prowl.Runtime.GraphicsBackend.DebugLayer;
using Prowl.Runtime.GraphicsBackend.Null;
...
/// <summary>
/// A Prowl Graphics Device provides all the rendering functions for a given physical graphics device.
/// </summary>
public abstract class GraphicsDevice : IDisposable
{
    ...
    public abstract InternalTexture CreateTexture(TextureDescription description);
    ...
    /// <returns>The created texture.</returns>
    public abstract InternalTexture CreateTexture<T>(TextureDescription description, T[] data) where T : unmanaged;
    ...
    /// <returns>The created texture.</returns>
    public abstract InternalTexture CreateTexture(TextureDescription description, IntPtr data);
    ...
    /// <param name="data">The pointer to the data.</param>
    /// <returns>The created texture.</returns>
    public abstract unsafe InternalTexture CreateTexture(TextureDescription description, void* data);
    ...
    public abstract InternalShader CreateShader(ShaderAttachment[] attachments);
    ...
    public abstract void UpdateTexture<T>(InternalTexture texture, int mipLevel, int arrayIndex, int x, int y, int z, int width,
    ...
    /// <param name="depth">The depth in pixels of the texture.</param>
    /// <param name="data">The data pointer.</param>
    public abstract void UpdateTexture(InternalTexture texture, int mipLevel, int arrayIndex, int x, int y, int z, int width,
    ...
    /// <param name="depth">The depth in pixels of the texture.</param>
    /// <param name="data">The data pointer.</param>
    public abstract unsafe void UpdateTexture(InternalTexture texture, int mipLevel, int arrayIndex, int x, int y, int z,
        int width, int height, int depth, void* data);

    /// <summary>
    /// Gets a region of this texture's data.
    /// </summary>
    /// <param name="texture">The texture to update.</param>
    /// <param name="mipLevel">The mip level to update.</param>
    /// <param name="arrayIndex">The array index to update.</param>
    ...
    /// <param name="depth">The depth in pixels of the texture.</param>
    /// <param name="data">The data pointer.</param>
    public abstract unsafe void GetTextureData(InternalTexture texture, int mipLevel, int arrayIndex, int x, int y, int z,
        int width, int height, int depth, void* data);
    ...
    public abstract void SetShader(InternalShader shader);
    ...
    public abstract void SetTexture(uint bindingSlot, InternalTexture texture, SamplerState samplerState);
    ...
    public abstract void GenerateMipmaps(InternalTexture texture);
    ...
    public static GraphicsDevice CreateOpenGL(Silk.NET.Core.Contexts.IGLContext context, Size winSize, bool isEs, GraphicsDeviceOptions options = default)
    {
