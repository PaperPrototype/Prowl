...
internal sealed class NullGraphicsDevice : GraphicsDevice
{
    ...
    public override InternalShader CreateShader(ShaderAttachment[] attachments, SpecializationConstant[] constants)
    {
        return new NullShader();
    }

    public override unsafe InternalTexture CreateTexture(TextureDescription description)
    {
        return new NullTexture(description, null);
    }

    public override unsafe InternalTexture CreateTexture<T>(TextureDescription description, T[] data)
    {
        fixed (void* ptr = data)
    ...
    public override unsafe InternalTexture CreateTexture(TextureDescription description, IntPtr data)
    {
    ...
    public override void UpdateTexture<T>(InternalTexture texture, int mipLevel, int arrayIndex, int x, int y, int z, int width, int height, int depth, T[] data)
    {
    }

    public override void UpdateTexture(InternalTexture texture, int mipLevel, int arrayIndex, int x, int y, int z, int width, int height, int depth, IntPtr data)
    {
    }

    public override unsafe void UpdateTexture(InternalTexture texture, int mipLevel, int arrayIndex, int x, int y, int z, int width, int height, int depth, void* data)
    {
    }
}
