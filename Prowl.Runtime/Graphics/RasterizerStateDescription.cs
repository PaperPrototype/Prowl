...
{
    /// <summary>
    /// No culling whatsoever, with a solid <see cref="Prowl.Runtime.GraphicsBackend.FillMode"/>, and with the scissor test disabled.
    /// </summary>
    ...
    /// <summary>
    /// Cull back faces in the clockwise direction, with a solid <see cref="Prowl.Runtime.GraphicsBackend.FillMode"/>, and with the scissor test disabled.
    /// </summary>
    ...
    /// <summary>
    /// Cull back faces in the counter-clockwise direction, with a solid <see cref="Prowl.Runtime.GraphicsBackend.FillMode"/>, and with the scissor test disabled.
    /// </summary>
    ...
    /// <summary>
    /// The <see cref="Prowl.Runtime.GraphicsBackend.FillMode"/>.
    /// </summary>
    ...
    /// <param name="fillMode">The <see cref="Prowl.Runtime.GraphicsBackend.FillMode"/>.</param>
