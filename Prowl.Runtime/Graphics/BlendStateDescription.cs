...
public struct BlendStateDescription
{
    ...
    /// <summary>
    /// The <see cref="Prowl.Runtime.GraphicsBackend.BlendOperation"/> to perform between the <see cref="Source"/> and the <see cref="Destination"/>.
    /// </summary>
    ...
    /// <summary>
    /// The <see cref="Prowl.Runtime.GraphicsBackend.BlendOperation"/> to perform between the <see cref="SourceAlpha"/> and the <see cref="DestinationAlpha"/>.
    /// </summary>
    ...
    /// <param name="blendOperation">The <see cref="Prowl.Runtime.GraphicsBackend.BlendOperation"/> to perform between the <see cref="Source"/> and the <see cref="Destination"/>.</param>
    ...
    /// <param name="alphaBlendOperation">The <see cref="Prowl.Runtime.GraphicsBackend.BlendOperation"/> to perform between the <see cref="SourceAlpha"/> and the <see cref="DestinationAlpha"/>.</param>
